...
import Search from "../ui/Search"; // Import Search Component
...
export default function Navbar() {
  const [open, setOpen] = useState(false);"use client";
...
export default function Navbar() {
  ...
  return (
    <>
      {/* UPDATED HEADER: 
        - Removed margins (mx-4) and rounded corners (rounded-full)
        - Added background colors explicitly for sticky effect
        - Added border-b for separation
      */}
      <header 
        className={`fixed top-0 left-0 right-0 z-[100] w-full transition-all duration-300 bg-white border-b border-zinc-100 ${
      ...
      >
        <nav className="mx-auto flex w-full items-center justify-between px-6 lg:px-12">
          ...
          <div className="flex items-center gap-4 pr-2">
            ...
            {/* Toggle Button - Ensures visibility on white background */}
            <button 
              type="button" 
