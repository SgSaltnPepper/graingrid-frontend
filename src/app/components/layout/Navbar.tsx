    ...
    <>
      ...
      */}
      ...
      >
        ...
        {/* Desktop Mega Menu */}
        <div ref={desktopMegaRef} onMouseLeave={() => setShowMega(false)} className="hidden absolute left-0 top-full w-full bg-white border-b-2 border-zinc-100 pt-8 pb-16 shadow-lg">
